// content.ts — Typed site content, mirrors profile.json from shared/types.ts
// Codegen edits THIS FILE for content changes. Low risk of breaking the build.
// Only layout/style changes touch component JSX.
...
// ─── Default content: Rose & Thorn (demo florist) ───
// Matches the demo script in docs/PLAN.md exactly.
